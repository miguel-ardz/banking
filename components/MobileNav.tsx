...
<Sheet>                    ← the whole drawer system
  ...
  <SheetContent>           ← the actual drawer that slides in
    <Link>                 ← the Horizon logo at the top
    <nav>                  ← the list of nav links
      {sidebarLinks.map}   ← loop through each link and render it
*/